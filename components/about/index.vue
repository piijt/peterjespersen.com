<template>
  <div>
    <h1 class="font-bold space-x-2 py-4">
      <span class="primary cursor-pointer">Hi</span>, I'm Peter👋
    </h1>
    <p class="space-x-2 pb-2">🌍 Denmark, Odense</p>
    <p class="space-x-2 pb-4">
      Software Developer, with expertise in system design & microservices.
      Thorough and curious by nature who loves to build full-stack projects.
    </p>
    <p>Employment History</p>
    <div class="text-sm">
      <div
        class="space-x-2 flex flex-col mt-2 pb-2"
        v-for="entry in employment_history"
      >
        ...
        <div class="">
          ...
          <blockquote class="text-md text-gray-300 cursor-vertical-text pt-1">
            "{{ entry.brief }}"
          </blockquote>
...
const employment_history = ref<employment_entry[]>([
  {
    ...
    current: true,
    brief:
      "At Kinematic, I develop and maintain software solutions in C++, C#, and Nuxt.js for the construction industry. My role involves building new features and optimizing existing functionalities to enhance user experience and efficiency.",
    tech: [
  ...
  },
  {
    ...
    brief:
      "As a Fullstack Developer, I was responsible for refactoring the backend from a PHP codebase to Node.js, significantly improving performance and maintainability. Trade-Raid.com enables gamers to trade digital assets across different games, helping them save money by avoiding duplicate purchases.",
    tech: [
      "https://img.shields.io/badge/Nuxt.js-282C34?style=for-the-badge&logo=nuxtdotjs&logoColor=white",
  ...
  },
  {
    ...
    brief:
      "At Cavea.io, I focused on backend development and DevOps, working with GCP and Node.js to build and deploy APIs, microservices, and ETL pipelines. My contributions enhanced scalability and data processing efficiency.",
    tech: [
      "https://img.shields.io/badge/Kubernetes-282C34?style=for-the-badge&logo=kubernetes&logoColor=white",
  ...
  },
  {
    ...
    brief:
      "Worked on an e-business concept aimed at helping engineers optimize Alfa Laval's products, reducing manufacturing costs and CO2 emissions across multiple industries.",
    tech: [],
  },
]);
